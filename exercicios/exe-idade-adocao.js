...
/*console.log(`Nome: ${dogs.nome}`)
console.log(`Idade: ${dogs.idade}`)
console.log(`Idade: ${dogs.porte.charAt(0).toUpperCase()}${dogs.porte.slice(1).toLowerCase()}`)
console.log(`Status: ${verificarSePodeSerAdotado(dogs.idade,dogs.porte,idadeMinimaParaAdocao)}`)
*/
console.table([{
    Nome: dogs[0].nome,
    Idade: dogs[0].idade,
